  ...
  languages: [
    {
      name: "HTML",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520" className="h-10 w-10">
    ...
    },
    {
      name: "JavaScript",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 630" className="h-10 w-10">
    ...
    },
    {
      name: "SASS",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 384" className="h-10 w-10">
  ...
  technologies: [
    {
      name: "React",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" className="h-10 w-10">
    ...
    },
    {
      name: "Material UI",
      icon: (
        <svg viewBox="0 0 600 476.30000000000007" xmlns="http://www.w3.org/2000/svg" className="h-10 w-10">
    ...
    },
    {
      name: "Tailwind CSS",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33" className="h-10 w-10">
    ...
    },
    {
      name: "Git",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92" className="h-10 w-10">
          <path d="M90.156 41.965 50.036 1.844a5.918 5.918 0 0 0-8.372 0l-8.328 8.331 10.567 10.567a7.03 7.03 0 0 1 7.23 1.684c3.168 3.168 3.168 8.307 0 11.475a8.118 8.118 0 0 1-11.475 0 7.034 7.034 0 0 1-1.684-7.23L28.301 16.998 3.475 41.825c-2.307 2.307-2.307 6.065 0 8.372l40.121 40.121c2.307 2.307 6.065 2.307 8.372 0l38.188-38.188c2.307-2.307 2.307-6.065 0-8.372z" fill="#f03c2e"/>
        </svg>
      )
    },
    {
      name: "Vite",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="410" height="404" viewBox="0 0 410 404" fill="none" className="h-10 w-10">
    ...
    },
    {
      name: "Next.js",
      icon: (
        <svg height="40" viewBox="0 0 180 180" width="40" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      icon: (
        <svg width="40" height="40" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M519.457 72.8095C511.35 67.9869 501.898 67.9869 493.791 72.8095L113.791 288.81C105.068 294.029 99.5908 303.118 99.5908 312.999V745.001C99.5908 754.882 105.068 763.971 113.791 769.19L493.791 985.19C501.898 990.013 511.35 990.013 519.457 985.19L899.457 769.19C908.18 763.971 913.657 754.882 913.657 745.001V312.999C913.657 303.118 908.18 294.029 899.457 288.81L519.457 72.8095ZM506.624 164L187.591 345.999V712.001L506.624 894L825.657 712.001V345.999L506.624 164Z" fill="url(#paint0_linear_1_127)"/>
          <defs>
            <linearGradient id="paint0_linear_1_127" x1="506.624" y1="68" x2="506.624" y2="990" gradientUnits="userSpaceOnUse">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256">
          <path fill="#FF6C37" d="M254.953 144.253c0-9.842-7.979-17.821-17.821-17.821c-9.842 0-17.82 7.979-17.82 17.821c0 9.842 7.978 17.821 17.82 17.821c9.842 0 17.821-7.979 17.821-17.821m-9.842 0c0 4.395-3.584 7.979-7.979 7.979c-4.394 0-7.978-3.584-7.978-7.979c0-4.394 3.584-7.978 7.978-7.978c4.395 0 7.979 3.584 7.979 7.978"/>
          <path fill="#FF6C37" d="m128.947 254.953c67.358 0 121.937-54.58 121.937-121.937c0-67.358-54.579-121.937-121.937-121.937C61.589 11.079 7.01 65.658 7.01 133.016c0 67.357 54.579 121.937 121.937 121.937m0-234.032c61.911 0 112.095 50.184 112.095 112.095c0 61.911-50.184 112.095-112.095 112.095c-61.911 0-112.095-50.184-112.095-112.095c0-61.911 50.184-112.095 112.095-112.095"/>
          <path fill="#FF6C37" d="M128.947 205.137c39.837 0 72.121-32.284 72.121-72.121c0-39.837-32.284-72.121-72.121-72.121s-72.121 32.284-72.121 72.121c0 39.837 32.284 72.121 72.121 72.121m0-134.4c34.39 0 62.279 27.889 62.279 62.279s-27.889 62.279-62.279 62.279s-62.279-27.889-62.279-62.279s27.889-62.279 62.279-62.279"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg width="40" height="40" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M64 128C99.3462 128 128 99.3462 128 64C128 28.6538 99.3462 0 64 0C28.6538 0 0 28.6538 0 64C0 99.3462 28.6538 128 64 128Z" fill="#5C4EE5"/>
          <path d="M85.0487 49.4351L78.4161 56.0677L71.7835 49.4351L78.4161 42.8025L85.0487 49.4351ZM78.4161 56.0677L71.7835 62.7003L65.1509 56.0677L71.7835 49.4351L78.4161 56.0677ZM71.7835 62.7003L65.1509 69.3329L58.5183 62.7003L65.1509 56.0677L71.7835 62.7003ZM65.1509 69.3329L58.5183 75.9655L51.8857 69.3329L58.5183 62.7003L65.1509 69.3329ZM58.5183 75.9655L51.8857 82.5981L45.2531 75.9655L51.8857 69.3329L58.5183 75.9655Z" fill="white"/>
        </svg>
      )
    }
  ]
      ...
      <div className="space-y-16">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-medium">Programlama Dilleri</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-medium">Framework ve Teknolojiler</h3>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5">
