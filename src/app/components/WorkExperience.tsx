...
const experiences = [
  {
    ...
    description:
      "Son 3.5 yıldır Müşteri Hizmetleri Temsilcisi olarak hem çağrı merkezi operasyonlarında hem de yazılı iletişimde görev almaktayım.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Otomotiv sektöründe çalıştım, uluslararası projelere katıldım ve bir yıl yurtdışında bulundum. Yenilikçi çözümler geliştirme ve global iş ortamında deneyim kazanma fırsatı elde ettim.",
  },
  {
    ...
    description:
      "OnlyJS Academy'de React.js, TypeScript, JavaScript, Bootstrap, Material-UI ve CSS-in-JS konularında uzmanlık kazandım. HTML, CSS, SASS ve CSSNext ile geliştirme sürecini optimize ediyor ve kullanıcı dostu arayüzler oluşturuyorum. Zustand ve React Hook Form ile durum ve form yönetimini geliştiriyorum. Dinamik ve interaktif web uygulamaları geliştirme konusunda yetenekliyim ve heyecan verici projelere katkıda bulunmaya hazırım.",
  },
];
    ...
    <section className="py-16">
      ...
      >
        {experiences.map((exp, index) => (
          <Card
            key={index}
            className="bg-gray-100 h-full border-2 border-gray-400 hover:shadow-lg hover:scale-105 hover:border-gray-300 duration-300 transition ease-in-out cursor-pointer"
          >
